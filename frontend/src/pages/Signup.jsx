      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        <div className="flex justify-center mb-6">
          <Link to="/" title="Go to Kingswood Education Center Home">
            <img src="/IMG_4244.png" alt="Kingswood Education Center Logo" className="h-16 w-16 rounded-2xl object-contain bg-white p-1 shadow-lg shadow-indigo-900/60 border border-indigo-400/30 transform hover:scale-105 transition-transform duration-300" />
          </Link>
        </div>
        ...
        <p className="mt-2 text-center text-sm font-medium text-indigo-200/80">
          Register for Kingswood Education Center
        </p>
      </div>
