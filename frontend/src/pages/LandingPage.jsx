...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans selection:bg-indigo-600 selection:text-white relative overflow-x-clip">
      ...
      {/* Decorative Background Glow Filters matching Emblem Theme */}
      <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-emerald-500/10 rounded-full blur-3xl pointer-events-none -z-0" />
      <div className="absolute top-[400px] right-10 w-[500px] h-[500px] bg-cyan-500/10 rounded-full blur-3xl pointer-events-none -z-0" />
      <div className="absolute top-[1800px] left-10 w-[600px] h-[600px] bg-amber-500/10 rounded-full blur-3xl pointer-events-none -z-0" />
      ...
      <header className={`sticky top-0 z-50 transition-all duration-500 ${
        ...
        <div className={`max-w-7xl mx-auto transition-all duration-500 ${
          isScrolled 
            ? 'bg-white/95 backdrop-blur-2xl border border-white/80 shadow-xl shadow-emerald-950/10 rounded-2xl px-4 sm:px-6 h-16' 
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            <div className="relative">
              <img
                ...
                className="w-10 h-10 sm:w-11 sm:h-11 rounded-2xl object-contain bg-white p-1 shadow-md shadow-emerald-950/20 border border-emerald-600/30 group-hover:scale-105 group-hover:border-emerald-500 transition-all duration-300 shrink-0"
              />
            ...
            <div>
              <span className="text-base sm:text-lg xl:text-xl font-extrabold text-slate-950 tracking-tight block group-hover:text-emerald-600 transition-colors">
                Kingswood Education Center
              </span>
              <span className="flex items-center gap-1.5 text-[10px] sm:text-[11px] font-bold text-emerald-700 tracking-wider uppercase">
            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`relative px-3.5 py-2 rounded-xl text-xs xl:text-sm font-bold transition-all duration-300 flex items-center space-x-1.5 group ${
                    isActive
                      ? 'text-emerald-700 bg-emerald-50/90 shadow-xs border border-emerald-200/80'
                      : 'text-slate-700 hover:text-emerald-600 hover:bg-emerald-50/50'
                  }`}
                >
                  <Icon className={`w-3.5 h-3.5 transition-transform duration-300 group-hover:scale-110 ${isActive ? 'text-emerald-600' : 'text-slate-400 group-hover:text-emerald-500'}`} />
                  <span>{item.label}</span>
                  {isActive && (
                    <span className="absolute -bottom-1 left-1/2 transform -translate-x-1/2 w-4 h-1 bg-gradient-to-r from-emerald-600 to-teal-600 rounded-full animate-pulse" />
                  )}
                </button>
              );
            })}
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Link
              to="/login"
              className="relative group overflow-hidden inline-flex items-center justify-center px-5 py-2.5 rounded-xl text-xs xl:text-sm font-extrabold text-white bg-gradient-to-r from-emerald-600 via-teal-600 to-blue-600 hover:from-emerald-500 hover:to-blue-500 shadow-md shadow-emerald-600/25 border border-emerald-400/20 transition-all duration-300 transform hover:-translate-y-0.5 hover:shadow-xl hover:shadow-emerald-600/35"
            >
              ...
              <LogIn className="w-4 h-4 mr-2 text-emerald-100 group-hover:rotate-12 transition-transform duration-300" />
              <span>Student Portal</span>
              <ChevronRight className="w-3.5 h-3.5 ml-1 text-emerald-100 group-hover:translate-x-1 transition-transform duration-300" />
            </Link>
          </div>
          ...
          <div className="md:hidden flex items-center">
            <button
              ...
              className="p-2 rounded-xl text-slate-700 hover:text-emerald-600 hover:bg-slate-100 focus:outline-none transition-colors"
            >
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white/95 border-b border-slate-200 px-4 pt-3 pb-6 space-y-2 backdrop-blur-2xl mt-2 rounded-b-2xl shadow-xl">
            ...
            <div className="pt-3">
              <Link
                to="/login"
                className="w-full flex items-center justify-center py-3 px-4 rounded-xl text-sm font-bold text-white bg-gradient-to-r from-emerald-600 via-teal-600 to-blue-600 hover:from-emerald-500 hover:to-blue-500 shadow-md shadow-emerald-600/30"
              >
                <LogIn className="w-4 h-4 mr-2 text-emerald-100" />
                Portal Log In
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
              ...
              <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-emerald-50 border border-emerald-200/80 text-emerald-800 text-xs sm:text-sm font-bold shadow-xs">
                <Sparkles className="w-4 h-4 text-amber-500 fill-amber-400" />
                <span>{cmsSettings?.heroTagline || '🏆 Premier Educational Institute | Grade 1 to Grade 13 (All Subjects)'}</span>
              </div>

              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-slate-950 tracking-tight leading-tight sm:leading-tight">
                {cmsSettings?.heroTitleLine1 || 'Empowering Academic Excellence &'}{' '}
                <br className="hidden sm:inline" />
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-emerald-700 via-teal-600 to-blue-600">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-2">
                <button
                  ...
                  className="w-full sm:w-auto px-8 py-4 rounded-xl text-base font-bold text-white bg-gradient-to-r from-emerald-600 via-teal-600 to-blue-600 hover:from-emerald-500 hover:to-blue-500 shadow-xl shadow-emerald-600/30 hover:shadow-emerald-600/40 transition-all transform hover:-translate-y-0.5 flex items-center justify-center border border-emerald-400/20"
                >
              ...
              {/* Stat Highlights Grid - Matching Theme */}
              <div className="pt-8 border-t border-slate-200 grid grid-cols-2 sm:grid-cols-4 gap-6">
                <div className="bg-emerald-50/50 p-4 rounded-2xl border border-emerald-100/80 shadow-xs text-center lg:text-left">
                  <div className="text-3xl font-black text-emerald-600">{cmsSettings?.statsRanks || '150+'}</div>
                  <div className="text-xs text-slate-600 mt-1 font-semibold">{cmsSettings?.statsRanksLabel || 'Island Ranks'}</div>
                </div>
                <div className="bg-teal-50/50 p-4 rounded-2xl border border-teal-100/80 shadow-xs text-center lg:text-left">
                  <div className="text-3xl font-black text-teal-600">{cmsSettings?.statsPassRate || '98%'}</div>
                  <div className="text-xs text-slate-600 mt-1 font-semibold">{cmsSettings?.statsPassRateLabel || 'A/B Grade Pass Rate'}</div>
                </div>
                <div className="bg-blue-50/50 p-4 rounded-2xl border border-blue-100/80 shadow-xs text-center lg:text-left">
                  <div className="text-3xl font-black text-blue-600">{cmsSettings?.statsStudents || '5,000+'}</div>
                  <div className="text-xs text-slate-600 mt-1 font-semibold">{cmsSettings?.statsStudentsLabel || 'Active Students'}</div>
                </div>
                <div className="bg-amber-50/50 p-4 rounded-2xl border border-amber-100/80 shadow-xs text-center lg:text-left">
                  <div className="text-3xl font-black text-amber-600">{cmsSettings?.statsExperience || '12+ Years'}</div>
